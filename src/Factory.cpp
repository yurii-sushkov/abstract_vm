...
Factory::EndException::EndException(){}

Factory::EndException::~EndException() throw(){}

char const * Factory::EndException::what(void) const throw()
{
	return "You cannot write any instructions after exit command line was executed.";
}